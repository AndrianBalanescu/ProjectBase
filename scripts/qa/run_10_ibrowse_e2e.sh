...
KEY="${IBROWSE_API_KEY:?Set IBROWSE_API_KEY to the iBrowse API key (not committed to the repo)}"
HOST="${IBROWSE_HOST:-http://127.0.0.1:3000}"
BASE="${PROJECTBASE_URL:-http://127.0.0.1:8120}"
