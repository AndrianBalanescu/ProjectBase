...
- [ ] #P0 todo **De-bloat `AgentsView.js` to a Clean, Fast Console (<800 lines)**
...
- [ ] #P0 todo **Safely Clean and Neutralize Balast Backend Hooks (112-119)**
  - Ensure all active API endpoints reflect real homelab infrastructure.
  - Maintain 100% test suite pass rate.

- [ ] #P1 todo **Fix Mobile Viewport Horizontal Overflow (207px -> 0px)**
  - Ensure 0px horizontal scroll across all screens.

- [ ] #P1 todo **Full Sceptic iBrowse & Pytest Verification**
