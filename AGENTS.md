...
- **Tests:** `pytest tests/` (run via `uv run --with pytest pytest tests/` or the pytest binary at `/home/ubuntu/.local/bin/pytest`). Tests run against the live instance (default `PROJECTBASE_URL=http://127.0.0.1:8120`, superuser `f@flow.com` / `superdev123`). 492 tests across 38 files.
...
tests/                 <- 492 tests across 38 files (test_agent_evaluations_engine.py, test_agents_drift_guard.py, test_api.py, test_auto_heal_pipeline.py, test_autonomous_runner_sync.py, test_autoscale_orchestration.py, test_benchmarks.py, test_bulk_actions.py, test_cluster_replication.py, test_code_review_swarm_engine.py, test_consensus_gates.py, test_css_sync.py, test_deploy_consistency.py, test_ephemeral_sandboxes_orchestrator.py, test_federation_analytics.py, test_fixture_hygiene.py, test_fleet_budget_quotas.py, test_foss_schema.py, test_git_workspace_engine.py, test_incident_warroom_engine.py, test_issue_relations.py, test_knowledge_graph_engine.py, test_multi_tenant_quotas.py, test_openapi_drift.py, test_sdk_observability.py, test_secret_scan.py, test_selfhosting.py, test_semantic_brain.py, test_session_branching_and_intervention.py, test_session_ingestion_engine.py, test_session_merges_conflict_engine.py, test_session_observability.py, test_session_trajectory_and_swarm.py, test_sso_rbac_matrix.py, test_swarm_dag.py, test_webhook_automation.py, test_workflow_automations.py, test_workspace_synthesis.py)
