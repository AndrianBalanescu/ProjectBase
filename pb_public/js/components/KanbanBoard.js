...
const KanbanBoardComponent = {
  ...
  emits: ['open-issue', 'create-issue', 'update-issue', 'delete-issue'],
  data() {
    return {
      columns: [
      ...
      this.columns.forEach(col => {
        ...
        const sortable = new Sortable(el, {
          ...
          onEnd: (evt) => {
            ...
            // Compute new order from neighbor elements
  ...
  template: `
    <div class="h-[calc(100vh-3.5rem)] overflow-x-auto overflow-y-hidden p-4 bg-[#0b0f19]">
      <div class="flex items-start space-x-4 h-full min-w-max pb-2">
        ...
        >
          ...
          >
            ...
            >
              <!-- Card Header: ID, Priority, Estimate -->
              <div class="flex items-center justify-between text-xs mb-1.5">
                <div class="flex items-center space-x-1.5">
                  <!-- Project Icon (if in All Projects mode) -->
